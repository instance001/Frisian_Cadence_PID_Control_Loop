...
| Conflict Compression Ratio (CCR) | CCR | = | ~ | Coherence metric | CCR = 1 − (edit_distance_with_cadence / edit_distance_baseline); higher suggests fewer contradictions post-cadence | Not a semantic accuracy guarantee; not causal proof; sensitive to baseline choice | Frisian_Cadence_PID_Control_Loop/Frisian_Cadence_PID_Control_Loop_Text_v0.2.txt |
